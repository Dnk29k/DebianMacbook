...
# Created by `pipx` on 2026-02-16 00:10:32
export PATH="$PATH:/home/dnk29/.local/bin"

# --- AUTOSTART BSPWM DESDE TTY1 ---
if [[ -z $DISPLAY && $XDG_VTNR -eq 1 ]]; then
  # Damos 1 segundo de respiro para que los drivers de video del Mac carguen
  sleep 1 && exec startx
fi

[ -f ~/.fzf.zsh ] && source ~/.fzf.zsh

# --- Funciones de Auditoría (Target) ---
function settarget(){
    if [ $# -ne 2 ]; then
        echo "Uso: settarget <IP> <NOMBRE>"
        return 1
    fi
    echo "$1 $2" > /home/dnk29/.config/bin/target
}
